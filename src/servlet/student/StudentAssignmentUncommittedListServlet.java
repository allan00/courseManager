...
public class StudentAssignmentUncommittedListServlet extends HttpServlet {

	public StudentAssignmentUncommittedListServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			// 要执行的SQL语句
			String sql = "select * from table_assignment where id not in(select assignmentId from assignment_answer where studentId='"
		...
		request.getRequestDispatcher("/student_assignment_uncommitted_list.jsp").forward(request, response);
		return;
	}
