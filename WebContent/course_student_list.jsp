...
<center>
<ul>
<li><a href="<%=path %>/StudentAdd">批量导入</a></li>
<li><a href="<%=path %>/CourseStudentAdd">增加学生</a></li>
...
<form name="form" action="<%=path %>/StudentImport" method="post" enctype="multipart/form-data">
<input type="file" name="importfile" id="importfile" size="30" /></br></br>
<input type="submit" value="导入" size="30" /></br></br>
</form>
