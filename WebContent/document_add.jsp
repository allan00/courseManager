...
<form method="post" action="<%=path %>/Teacher/DocumentAdd" enctype="multipart/form-data">
<div class="mainziyuan">
     <div id="duiqi">
    <div id = "dvTitles"></div>
                <input type="button" class="liulan" type="button" value="添加文件" onclick="addFile('dvTitles','file')"  />        
     </div>
     <div class="juzhong">
          <div><input type="submit"  value="添加" class="btntijiao"  onclick="this.disabled='true'"/></div>
     </div>
</div>
</form>
