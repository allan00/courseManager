...
<form id="meg" name="meg" action="<%=path %>/Teacher/MessageUpdate?id=${message.id }" method="post">
     <div class="zuoyebiaoti">标题：<input type="text" name="title" id="title" class="text" value="${message.title }"/></div>
     <div class="zuoyebiaoti">发布人：<input type="text" name="author" id="author" value="${message.author }" /></div>
     <div class="zuoyejiezhiriqi"></div> 
   <label for="textarea"></label>
    <textarea id="content" name="content" class="zuoyeneirong" value="${message.content }" ></textarea>
     <div id = "dvTitles"></div>
